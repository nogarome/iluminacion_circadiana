...
export const ArduinoDocs: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 pb-20">
      ...
      {/* ALERTA VERSION */}
      <section className="bg-green-50 p-6 rounded-2xl border border-green-200 shadow-md">
         <div className="flex items-start gap-4">
             <div className="bg-green-100 p-3 rounded-full text-green-600">
                <CheckCircle2 size={32} />
             </div>
             <div>
                <h3 className="text-xl font-bold text-green-900 mb-2">¡IMPORTANTE! Actualización V4.8</h3>
                <p className="text-green-800 text-sm leading-relaxed mb-3">
                    Hemos introducido un algoritmo de <strong>Alta Precisión Solar</strong>. Ahora el código calcula la "Ecuación del Tiempo" y corrige tu longitud y huso horario.
                </p>
                <ol className="list-decimal list-inside text-sm text-green-800 space-y-1 font-bold">
                    <li>Copia y sube el nuevo código.</li>
                    <li>Monitor Serie debe decir: <span className="font-mono bg-white px-1 rounded border border-green-300">Luminia V4.8 ... SOLAR PRECISION</span></li>
                    <li>¡IMPORTANTE! Verifica que el Huso Horario (TZ) está bien configurado en la app y subido al Arduino.</li>
                </ol>
             </div>
         </div>
      </section>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2 text-xs font-mono">
                    <div className="grid grid-cols-2 gap-2 border-b border-slate-800 pb-1 pt-2">
                        <span className="text-cyan-400 font-bold">TZ:X</span>
                        <span className="text-slate-500">Huso Horario (1, 2, -5...)</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 border-b border-slate-800 pb-1">
                        <span className="text-fuchsia-400">BRISTART:X</span>
                        <span className="text-slate-500">Bri Trigger (ej: -6.0)</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2 border-b border-slate-800 pb-1">
                        <span className="text-fuchsia-400">BRIFULL:X</span>
                        <span className="text-slate-500">Bri Max (ej: 45.0)</span>
                    </div>
